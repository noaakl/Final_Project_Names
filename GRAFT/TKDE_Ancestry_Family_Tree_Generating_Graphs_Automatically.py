...
def create_child_father_sframe(wikitree_sf, target_field_name):
    ...
    wikitree_sf = wikitree_sf[(wikitree_sf[target_field_name] != None) &
                              (wikitree_sf[target_field_name] != 'None') &
    ...
    wikitree_sf[target_field_name] = wikitree_sf[target_field_name].apply(lambda x: clean_content(x))

    wikitree_sf[target_field_name] = wikitree_sf[target_field_name].apply(lambda x: x.strip())

    wikitree_sf = wikitree_sf.filter_by(ancestry_names, target_field_name)
...
def clean_prefix_names_child_father(sf, target_field_name, parental_relation_type, prefix_names):
    ...
    sf = sf.filter_by(ancestry_names, 'Child_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'Father_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'Mother_' + targeted_field_name)
...
def clean_prefix_names_child_grandfather(sf, target_field_name, parental_relation_type, prefix_names):
    ...
    sf = sf.filter_by(ancestry_names, 'Child_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'Grandfather_father_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'Grandmother_father_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'Grandfather_mother_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'Grandmother_mother_' + targeted_field_name)
...
def clean_prefix_names_child_greatgrandfather(sf, target_field_name, parental_relation_type, prefix_names):
    ...
    sf = sf.filter_by(ancestry_names, 'Child_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'GreatGrandfather_Grandfather_father_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'GreatGrandmother_Grandfather_father_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'GreatGrandfather_Grandmother_father_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'GreatGrandmother_Grandmother_father_' + targeted_field_name)

    sf = sf.filter_by(ancestry_names, 'GreatGrandfather_Grandfather_mother_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'GreatGrandmother_Grandfather_mother_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'GreatGrandfather_Grandmother_mother_' + targeted_field_name)
    sf = sf.filter_by(ancestry_names, 'GreatGrandmother_Grandmother_mother_' + targeted_field_name)
