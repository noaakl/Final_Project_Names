...
def upload_gram_frequencies_dict1():
    with open('gram_dictionaries/gram_frequencies_dictionary_1.pkl', 'rb') as f:
        loaded_dict = pickle.load(f)
    return loaded_dict


def upload_gram_frequencies_dict2():
    with open('gram_dictionaries/gram_frequencies_dictionary_2.pkl', 'rb') as f:
        loaded_dict = pickle.load(f)
    return loaded_dict


def upload_gram_frequencies_dict3():
    with open('gram_dictionaries/gram_frequencies_dictionary_3.pkl', 'rb') as f:
        loaded_dict = pickle.load(f)
    return loaded_dict
...
gram_frequencies1 = upload_gram_frequencies_dict1()
...
import pandas as pd
all_top_grams_csv = pd.read_csv("gram_dictionaries/all_top_grams.csv").columns
